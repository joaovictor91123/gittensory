...
import type { HouseRulesConfig, HouseRulesOptions } from "./coding-agent-house-rules.js";
...
export function constructProductionCodingAgentDriver(
  ...
  const hooks =
    ...
    (providerName.trim().toLowerCase() === "agent-sdk"
      ? buildHouseRulesAgentSdkHooks(options.houseRulesConfig as HouseRulesConfig | undefined, options.houseRulesOptions as HouseRulesOptions | undefined)
      : undefined);
