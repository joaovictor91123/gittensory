...
describe("loopover-miner local storage README (#4272, #4876)", () => {
  it("documents every local SQLite store with file/table/module/env-var", () => {
    ...
    for (const row of [
      ...
      ["claim-ledger.sqlite3", "miner_claims", "claim-ledger.js", "LOOPOVER_MINER_CLAIM_LEDGER_DB"],
      ["portfolio-queue.sqlite3", "miner_portfolio_queue", "portfolio-queue.js", "LOOPOVER_MINER_PORTFOLIO_QUEUE_DB"],
      ["event-ledger.sqlite3", "miner_event_ledger", "event-ledger.js", "LOOPOVER_MINER_EVENT_LEDGER_DB"],
      ["plan-store.sqlite3", "miner_plans", "plan-store.js", "LOOPOVER_MINER_PLAN_STORE_DB"],
      ["governor-ledger.sqlite3", "governor_events", "governor-ledger.js", "LOOPOVER_MINER_GOVERNOR_LEDGER_DB"],
      ["governor-state.sqlite3", "governor_scalar_state", "governor-state.js", "LOOPOVER_MINER_GOVERNOR_STATE_DB"],
      ["attempt-log.sqlite3", "attempt_log_events", "attempt-log.js", "LOOPOVER_MINER_ATTEMPT_LOG_DB"],
      ["prediction-ledger.sqlite3", "predictions", "prediction-ledger.js", "LOOPOVER_MINER_PREDICTION_LEDGER_DB"],
      ["replay-snapshot.sqlite3", "replay_snapshots", "replay-snapshot.js", "LOOPOVER_MINER_REPLAY_SNAPSHOT_DB"],
